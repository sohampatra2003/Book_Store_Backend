...
const ViewBookDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetch = async () => {
      const res = await axios.get(
        `https://book-store-web-6op0.onrender.com/api/v1/get-book-by-id/${id}`
      );
  ...
  const addToFavourite = async () => {
    try {
      const response = await axios.put(
        "https://book-store-web-6op0.onrender.com/api/v1/add-to-favourite",
        {},
        { headers }
      );
  ...
  const addToCart = async () => {
    try {
      const response = await axios.put(
        "https://book-store-web-6op0.onrender.com/api/v1/add-to-cart",
        {},
        { headers }
      );
      alert(response.data.message);
  ...
  const deleteBook = async () => {
    try {
      const response = await axios.delete(
        "https://book-store-web-6op0.onrender.com/api/v1/delete-book",
        { headers }
      );
      alert(response.data.message);
      history("/all-books");
